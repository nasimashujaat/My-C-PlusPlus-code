    ...
    while (playerOption != 0)
    {
        ...
        if (reply == true || drawGame == 0)
        {
            ...
            do {
                ...
                if (playerOption != 0)
                {
                    cout << " Do you want to change Dimensions? Press 1: Yes and 0: No";
                    cin >> changedimensions;
                }
